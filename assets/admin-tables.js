...
function setupCourseContentManagement() {
    ...
    if (addBtn) {
        addBtn.addEventListener('click', async function() {
            ...
            const previewUrl = document.getElementById('content-preview-url').value.trim();
            ...
            if (result.success) {
                ...
                document.getElementById('content-preview-url').value = '';
        ...
        contentList.addEventListener('click', async function(e) {
            ...
            if (editBtn || deleteBtn) {
                ...
                if (deleteBtn) {
                    ...
                    const content = await fetch('/backend/api/course-content.php?id=' + id).then(r => r.json());
